    ...
    loadData() {
        this.data = [
            ...
            },
            {
                ...
                interesados: 4,
                comentarios: [
                    { productor: "pedro", descripcion: "malo", fecha: new Date("02/02/2000") },
                    { productor: "pedro", descripcion: "bueno", fecha: new Date("02/02/2002") }]
            },
            {
                idPropietario: "101",
                telefono: "3453456789",
                ...
                comentarios: [
                    { productor: "pedro", descripcion: "malo", fecha: new Date("02/02/2000") },
                    { productor: "pedro", descripcion: "regular", fecha: new Date("02/02/2002") },
                    { productor: "pedro", descripcion: "bueno", fecha: new Date("02/02/2004") }]
            }
        ];
    }
